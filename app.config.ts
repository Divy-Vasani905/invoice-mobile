 ...
 * Replace via EXPO_PUBLIC_ADMOB_*_APP_ID before production release builds.
 * @see https://developers.google.com/admob/android/test-ads
 *
 * Ads are currently disabled — AdMob plugin commented out below.
 */
...
export default ({ config }: ConfigContext): ExpoConfig => ({
  ...
  android: {
    ...
    permissions: [
      ...
      // 'com.google.android.gms.permission.AD_ID', // ads disabled
