...
export const ROUTES = {
  ...
  paymentReminders: '/settings/payment-reminders' as Href,
  ...
  invoicePdfPreview: (invoiceId: string): Href => `/invoice-pdf/${invoiceId}` as Href,
...
export const ROUTE_NAMES = {
  ...
  modals: {
    ...
    invoicePdfPreview: '(modals)/invoice-pdf/[invoiceId]',
